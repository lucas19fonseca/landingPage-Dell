            ...
            <div className="max-w-6xl mx-auto px-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 mt-15">
                    ...
                    <div className="group bg-white p-12 border border-gray-300 text-center relative transition-all duration-400 hover:bg-black hover:text-white hover:scale-102 hover:z-10 hover:shadow-xl">
                        <div className="text-5xl mb-6 text-black transition-colors duration-400 group-hover:text-white">
                            <i className="fas fa-hands"></i>
                        </div>
                        <h3 className="text-xl mb-5 font-normal uppercase tracking-wide">
                            Liberação Miofascial
                        </h3>
                        <p className="text-gray-600 leading-relaxed text-sm transition-colors duration-400 group-hover:text-gray-300">
